    ...
    doctors: [
        {
            ...
            short_description: 'Один из крупнейших мировых экспертов в области лечения колена. В его честь названа точка в колене - "точка Шёттле". Он является консультантом Ватикана по...',
...

        {
            ...
            short_description: 'Один из ведущих специалистов по лечению заболеваний позвоночника в Европе. Известен на весь мир малоинвазивными методами лечения...',
...

        {
            ...
            area: 'Лечение и хирургия позвоночника',
            short_description: 'Если у вас боли в спине неизвестного происхождения, то вам непременно нужно познакомиться с доктором Вальтером. С 2001 года он серьезно...',
...

        {
            ...
            short_description: 'Вы думаете все хирурги работают скальпелем. А вот и нет! Доктор Шеттле большой эксперт по биорегенеративной терапии. Он активно использует...',
...

        {
            ...
            short_description: 'Мастер в области ортопедической хирургии. Профессор проводит около 800 операций ежегодно. Неоднократно попадал в список лучших...',
...

        {
            ...
            area: 'Лечение и хирургия плечевых суставов',
            short_description: 'Занимается исключительно плечевыми суставами и знает об этом все. Обеспечивает полный спектр услуг по современному лечению и хирургии...',
...

        {
            ...
            short_description: 'Филигранный мастер в хирургии кистей и рук. Возращает не только здоровьем вашим кистям, но и красоту. Совмещает травматическую и...',
...

        {
            ...
            area: 'Лечение и хирургия рук',
            short_description: 'Доктор Лених выглядит моложе, чем есть на самом деле, и любит иногда пошутить на эту тему с пациентами, притворившись...',
...

        {
            ...
            short_description: 'Хотите бегать, прыгать, заниматься спортом без болей в голеностопе? Вам к доктору Кинаст. Он расскажет вам все как есть, отговорит...',
...

        {
            ...
            area: 'Лечение и хирургия плечевых суставов',
            short_description: 'С 1982 года специализируется на хирургии плечевых суставов. В 1984 основывает первый в Германии центр по хирургии плеча. В настоящий...',
...
createDoctorHTML = (doctor) => {
    ...
    short_description.innerHTML = doctor.short_description;
    li.append(short_description);
